...
public:
  //! The value type of the generic code, which is a `win32::DWORD`
  ...
  public:
    ...
    explicit string_ref(win32::DWORD c)
    {
      ...
      win32::DWORD wlen = win32::FormatMessageW(0x00001000 /*FORMAT_MESSAGE_FROM_SYSTEM*/ | 0x00000200 /*FORMAT_MESSAGE_IGNORE_INSERTS*/, 0, c, 0, buffer, 32768, 0);
      if(wlen == 0)
        goto failure;
